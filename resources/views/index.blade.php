...
<section class="py-xxl-10 pb-0" id="home">
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-7 col-xl-6 col-xxl-5 text-md-start text-center py-5">
        <h1 class="fw-bold text-primary fs-7">Fast & Secure</h1>
        <h1 class="fw-bolder text-success fs-3 mb-3">Courier Services at Your Doorstep</h1>
        <p class="text-white fs-6 mb-4">
          from <span class="text-primary fw-bold">pickup</span> to <span class="text-primary fw-bold">doorstep</span> all in one place
        </p>
  ...
  <div class="container" >
    ...
    <div class="row h-100 justify-content-center">
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="pt-7 pb-0" style="background-color:#012b3c;">
  <div class="container">
    ...
    <div class="row">
      <div class="col-12" data-aos="fade-up">
        ...
        <div class="card bg-dark text-white overflow-hidden shadow-lg">
          ...
          <!-- Overlay -->
          <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center text-center  bg-opacity-50" style="background-color:  #012b3c;;">
...
<div class="row px-3 px-md-0 mt-6">
  ...
  <div class="d-grid">
    <button class="btn btn-success" type="submit">Send Message <i class="fas fa-paper-plane ms-2"></i></button>
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
     <section id="findUs" class="py-6" style="background-color:#f0f9ff;">
  <div class="container">
